...
def main():
    ...
    start_message = "UMAP+DBSCAN clustering run has started."
    ...
    message = (
        "UMAP+DBSCAN clustering completed successfully.\n"
...
if __name__ == "__main__":
    try:
        ...
        error_message = (
            "UMAP+DBSCAN clustering pipeline encountered an error:\n" +
